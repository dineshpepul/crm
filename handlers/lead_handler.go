...
func (h *LeadHandler) GetLeads(c *gin.Context) {
	leads, err := h.leadService.GetLeads()
	if err != nil {
...
func (h *LeadHandler) GetAllFieldConfigs(c *gin.Context) {
	configs, err := h.leadService.GetAllFieldConfigs()
	if err != nil {
...
func (h *LeadHandler) GetVisibleFieldConfigs(c *gin.Context) {
	configs, err := h.leadService.GetVisibleFieldConfigs()
	if err != nil {
...
func (h *LeadHandler) GetRequiredFieldConfigs(c *gin.Context) {
	configs, err := h.leadService.GetRequiredFieldConfigs()
	if err != nil {
...
func (h *LeadHandler) ExportLeads(c *gin.Context) {
	...
	leads, err := h.leadService.ExportLeads(filters)
	if err != nil {
...
func (h *LeadHandler) GetAllFormSections(c *gin.Context) {
	sections, err := h.leadService.GetAllFormSections()
	if err != nil {
...
func (h *LeadHandler) GetVisibleFormSections(c *gin.Context) {
	sections, err := h.leadService.GetVisibleFormSections()
	if err != nil {
